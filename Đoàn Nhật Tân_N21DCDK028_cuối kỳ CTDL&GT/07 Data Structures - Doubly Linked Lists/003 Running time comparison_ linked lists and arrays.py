...
for i in range(500000):
    L.addlast(i)
print('inserting items into linked list  in  %ss' % str(time.time()-now))# in ra thời gian chạy khi thêm 500000 phần tử bằng cách dùng linked list
...
for i in range(500000):
    array.insert(0,i)
print('inserting items into   arrray  %ss' % str(time.time()-now))# in ra thời gian chạy khi thêm 500000 phần tử bằng cách dùng array
